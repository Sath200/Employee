...
internal class EmployeeServiceTest {
    ...
    @Test
    fun `should not create employee when age is less than 18`(){
    ...
    @Test
    fun `should throw error for non existent employee` (){
    ...
    @Test
    fun `should throw error when trying to delete non existent employee` (){
        every { employeeRepository.findById(fakeEmployee.employeeId) } returns Optional.empty()
    ...
    @Test
    fun `should throw 404 when trying to update non existent employee`(){
